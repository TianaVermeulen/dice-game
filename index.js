...
var randomDiceImage1 = document.querySelector("img.img1").setAttribute("src", 'images/dice' + randomNumber1 + '.png');
var randomDiceImage2 = document.querySelector("img.img2").setAttribute("src", 'images/dice' + randomNumber2 + '.png');
var randomDiceImage3 = document.querySelector("img.img3").setAttribute("src", 'images/dice' + randomNumber3 + '.png');
...
else if (randomNumber1==randomNumber3 && randomNumber1!==randomNumber2 && randomNumber3!==randomNumber2){
    document.querySelector("h1").textContent = "Player 2 Loses! 🚩";
}
else if (randomNumber2==randomNumber3 && randomNumber2!==randomNumber1 && randomNumber3!==randomNumber1){
